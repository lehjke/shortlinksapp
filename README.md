...
## Возможности
- Генерация коротких ссылок вида `https://clck.ru/XXXXXXX`.
...
2. **Вход** – укажите ранее полученный UUID, чтобы управлять своими ссылками (создавать, просматривать, удалять).
...
| --- | --- | --- |
| `app.short-link-domain` | `https://clck.ru/` | Базовый домен для коротких ссылок. |
